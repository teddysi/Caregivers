...
class HealthcareProPatientEditFailTest extends DuskTestCase
{
    ...
    public function testBasicExample()
    {
        ...
        $this->browse(function (Browser $browser) use ($patient, $messages) {
            $browser->loginAs(HealthcarePro::find(14))
                    ...
                    ->assertSeeIn('a[href=\'http://192.168.99.100/patients/9/edit\']', 'Editar')
                    ->click('a[href=\'http://192.168.99.100/patients/9/edit\']', 'Editar')
                    ->assertPathIs('/'.'patients/9/edit')
