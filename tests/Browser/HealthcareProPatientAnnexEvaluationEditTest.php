...
class HealthcareProPatientAnnexEvaluationEditTest extends DuskTestCase
{
    ...
    public function testBasicExample()
    {
        ...
        $this->browse(function (Browser $browser) use ($evaluation, $fields_to_update)  {
            $browser->loginAs(HealthcarePro::find(14))
                    ...
                    ->assertPathIs('/'.'evaluations/5/edit')
            ...
            $browser->assertSeeIn('table ', $evaluation->description)
                    ->assertSeeIn('a[href=\'http://192.168.99.100/evaluations/5\']', 'Detalhes')
                    ->click('a[href=\'http://192.168.99.100/evaluations/5\']', 'Detalhes')
