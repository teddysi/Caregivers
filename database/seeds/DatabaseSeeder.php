...
class DatabaseSeeder extends Seeder
{
    ...
    private function buildImages()
    {
        ...
        foreach ($images_name as $name) {
            ...
            $image->type = 'image';
            $image->url = 'http://192.168.99.100/caregivers/public/materials/'.($countMaterials+1).'/showContent';
    ...
    private function buildVideos()
    {
        ...
        foreach ($videos_name as $name) {
            ...
            $video->type = 'video';
            $video->url = 'http://192.168.99.100/caregivers/public/materials/'.($countMaterials+1).'/showContent';
    ...
    private function buildAnnexs()
    {
        ...
        foreach ($annexs_name as $name) {
            ...
            if ($annex->name != 'Anexo-4' && $annex->name != 'Anexo-5') {
                $annex->url = 'http://192.168.99.100/caregivers/public/materials/'.($countMaterials+1).'/showContent';
