							...
							<tr>
								...
								<td style="width:70%">
									<div class="row">
                                        ...
                                        <div class="col-sm-6 col-md-2 col-lg-2">
											<form action="{{ route('users.diassociateCaregiver', ['user' => $user->id, 'caregiver' => $caregiver->id]) }}" method="POST" class="form-group">
												{{ csrf_field() }}
												<div class="form-group">
							...
							<tr>
								...
								<td style="width:70%">
									<div class="row">
                                        ...
                                        <div class="col-sm-6 col-md-3 col-lg-3">
											<form action="{{ route('users.associateCaregiver', ['user' => $user->id, 'caregiver' => $otherCaregiver->id]) }}" method="POST" class="form-group">
												{{ csrf_field() }}
												<div class="form-group">
